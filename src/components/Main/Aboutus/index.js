            ...
            <div className="team-members">
              <div className="member">
                ...
                <div className="mem-info">
                  ...
                  <div className="desig-mem">Fullstack Dev</div>
                </div>
              </div>
              <div className="member">
                <div className="photo-mem-2"></div>
                <div className="mem-info">
                  <div className="name-mem">Gurjeet Singh</div>
                  <div className="desig-mem">UI/UX & Frontend</div>
                </div>
              </div>
            </div>
          </Fade>
